def ranges():
  ...
  # # starts at 0 and ends at 119 because it types in 120 numbers starting from 0
  # # IMPORTANT
  # my_list = list(range(0,78))
  # for number in my_list:
  #   # num is divisible by 2 == 0 even
  #   # number divisible by 2 == 1 odd
  #   if number % 2 == 0:
